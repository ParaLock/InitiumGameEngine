...
//	~InsertionSort();
//
//	void particleSelectionSort(std::vector<ParticleData*>* arr) {
//
//		if (arr->size() == 0)
//			return;
//
...
//	}
//
//	bool particleBatchSelectionSort(std::vector<std::tuple<ParticleBatch, RenderPassPacket_ParticleEmitterData*>>* arr) {
//
//		if (arr->size() == 0)
//			return false;
//
